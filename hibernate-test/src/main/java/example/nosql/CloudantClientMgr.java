...
public class CloudantClientMgr {
	...
	private static String databaseName = "test_1";

	private static String user = "d6c0dbf0-e2ed-41cc-87b4-7327d6fdc417-bluemix";
	private static String password = "82655cdf3718e1e63b71aaeae6bbd1d7aa589213db5162c2161ed57f1dcae251";
